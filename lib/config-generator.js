...
function buildLocalEnv(options = {}) {
  const llmModel = valueOf(options, "llmModel");
  const embeddingModel = valueOf(options, "embeddingModel");
  const ollamaBaseUrl = "http://host.docker.internal:11434/v1";
  ...
  return [
    ...
    "",
    "# Ollama's OpenAI-compatible endpoint does not validate this value.",
    ...
    `EMBEDDING_MODEL_CONFIG__OVERRIDES__BASE_URL=${ollamaBaseUrl}`,
    "",
    "DERIVER_MODEL_CONFIG__TRANSPORT=openai",
    `DERIVER_MODEL_CONFIG__MODEL=${llmModel}`,
    `DERIVER_MODEL_CONFIG__OVERRIDES__BASE_URL=${ollamaBaseUrl}`,
    "",
    "SUMMARY_MODEL_CONFIG__TRANSPORT=openai",
    `SUMMARY_MODEL_CONFIG__MODEL=${llmModel}`,
    `SUMMARY_MODEL_CONFIG__OVERRIDES__BASE_URL=${ollamaBaseUrl}`,
    "",
    "DREAM_DEDUCTION_MODEL_CONFIG__TRANSPORT=openai",
    `DREAM_DEDUCTION_MODEL_CONFIG__MODEL=${llmModel}`,
    `DREAM_DEDUCTION_MODEL_CONFIG__OVERRIDES__BASE_URL=${ollamaBaseUrl}`,
    "",
    "DREAM_INDUCTION_MODEL_CONFIG__TRANSPORT=openai",
    `DREAM_INDUCTION_MODEL_CONFIG__MODEL=${llmModel}`,
    `DREAM_INDUCTION_MODEL_CONFIG__OVERRIDES__BASE_URL=${ollamaBaseUrl}`,
    "",
    "DIALECTIC_LEVELS__minimal__MODEL_CONFIG__TRANSPORT=openai",
    `DIALECTIC_LEVELS__minimal__MODEL_CONFIG__MODEL=${llmModel}`,
    `DIALECTIC_LEVELS__minimal__MODEL_CONFIG__OVERRIDES__BASE_URL=${ollamaBaseUrl}`,
    "DIALECTIC_LEVELS__low__MODEL_CONFIG__TRANSPORT=openai",
    `DIALECTIC_LEVELS__low__MODEL_CONFIG__MODEL=${llmModel}`,
    `DIALECTIC_LEVELS__low__MODEL_CONFIG__OVERRIDES__BASE_URL=${ollamaBaseUrl}`,
    "DIALECTIC_LEVELS__medium__MODEL_CONFIG__TRANSPORT=openai",
    `DIALECTIC_LEVELS__medium__MODEL_CONFIG__MODEL=${llmModel}`,
    `DIALECTIC_LEVELS__medium__MODEL_CONFIG__OVERRIDES__BASE_URL=${ollamaBaseUrl}`,
    "DIALECTIC_LEVELS__high__MODEL_CONFIG__TRANSPORT=openai",
    `DIALECTIC_LEVELS__high__MODEL_CONFIG__MODEL=${llmModel}`,
    `DIALECTIC_LEVELS__high__MODEL_CONFIG__OVERRIDES__BASE_URL=${ollamaBaseUrl}`,
    "DIALECTIC_LEVELS__max__MODEL_CONFIG__TRANSPORT=openai",
    `DIALECTIC_LEVELS__max__MODEL_CONFIG__MODEL=${llmModel}`,
    `DIALECTIC_LEVELS__max__MODEL_CONFIG__OVERRIDES__BASE_URL=${ollamaBaseUrl}`,
    "",
    "ENVIRONMENT=local",
    "LOG_LEVEL=INFO",
    "",
...
function buildLocalComposeOverride(options = {}) {
  return [
    ...
    '      - "sh"',
    '      - "-c"',
    '      - "/app/.venv/bin/python scripts/provision_db.py && /app/.venv/bin/python scripts/configure_embeddings.py --yes && exec /app/.venv/bin/fastapi run --host 0.0.0.0 src/main.py"',
    "    ports: !override",
